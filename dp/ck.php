...
<title>m3u8</title>
<style type="text/css">body,html,.huiv{background-color:#000;padding: 0;margin: 0;width:100%;height:100%;}</style>
...
<div class="huiv"></div>
<script type="text/javascript">var huiid = "<?php echo $_GET['url'];?>"; </script>
